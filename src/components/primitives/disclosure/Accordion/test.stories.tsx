...
const meta: Meta<typeof Accordion> = {
  component: Accordion,
  title: 'components/primitives/disclosure/Accordion/test',
  args: {
    onSubmit: fn(),
  },
}
...
export const ShouldToggleItem: Story = {
  args: {
    items: data,
    multiple: false,
    collapsible: false,
...
export const ShouldAllowMultipleOpen: Story = {
  args: {
    items: data,
    multiple: true,
    collapsible: false,
...
export const ShouldHaveDefaultValue: Story = {
  args: {
    items: data,
    multiple: true,
    collapsible: true,
